# Historical roadmap artifacts (read-only)

Material under `20_Roadmap/_historical/` is **not** current execution guidance. It predates the S1–S6 strategic plan (`plans/cursor/strategic-roadmap-reframe-53be/`) and the **web** flagship (`finance_manager_web`).
