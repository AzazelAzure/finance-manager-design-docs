...
**Strategic source of truth:** `strategy/strategic-roadmap-reframe-53be/` (Phase **S1**, Stage **S1.B** as of 2026-05-01). This page summarizes how `design_docs` describes the live system; where they diverge, the strategic plan and `governance/glossary.md` win.
...
| **Reflex** | Archived (historical) | `finance_manager_reflex/` | Removed from production architecture 2026-04-30; repo retained for evidence only (`strategy/strategic-roadmap-reframe-53be/00_strategic_context.md` §3.1). Reflex-specific docs under `design_docs/reflex_docs/` are historical. |
