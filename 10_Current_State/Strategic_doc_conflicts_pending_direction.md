...
**Canonical strategy:** `strategy/strategic-roadmap-reframe-53be/` + `governance/glossary.md`.
...
| 2026-05-01 cutline + runtime sheet | **Applied:** `Beta_Launch_Cutline_and_SPA_Transition.md` rewritten for **web** flagship + **S1.B** distribution gate; `Runtime_Signup_Sheet.md` example owner scope uses **S1.B** (not legacy “Phase 2”). |
